...
Class ClassCls
		...
		End Sub
			...
			With Response
				...
				.Write "          <dd><div>" & MyFolderName & "名称：</div>" & vbCrLf
				.Write "             <label id='add1'>"
				.Write "            <INPUT class='textbox' name='FolderName' onkeyup='ctoe()' type='text' value='" & FolderName & "' id='FolderName' title='请输入" & MyFolderName & "名称' size=30><font color=red>*</font><span>概括性的说明文字</span> &nbsp;&nbsp;<Select name='firstAlphabet' id='firstAlphabet'><option value='0'>首字母</option>"
				Dim I
				For I=65 To 90
			...
			.Write "        </select>" & vbCrLf
			   ...
			   if action<>"Add" then
				...
				.Write " </dd>" & vbCrLf
					 ...
					 .Write " <dd><div>手机版内容页模板：</div>" & vbCrLf
				...
				.Write "   case 3:$('#3gtemplate').hide();$('#editorarea').show();$('#fsohtmlarea').hide();$('#classarea').html('生成文件名：');$('#classtips').html('如 <font color=blue>about.html,intro.html,help.html</font>等');$('#templatearea').show();$('#temparea').hide();$('#channel').hide();"
