...
Class RefreshFunction
					         ...
					         Dim RSB:Set RSB=Conn.Execute("select top 1 * From " & KS.C_S(BChannelID,2) & " Where ID=" & KS.ChkClng(FieldValue))
							  If Not RSB.Eof Then
								if BFieldName="url" then
								 FieldValue= KS.GetItemURL(BChannelID,RSB("Tid"),KS.ChkClng(FieldValue),RSB("Fname"))
								Else
		   ...
		   Else 
			 ...
			 Select Case KS.C_S(ModelID,6) 
			  ...
			  Case 3  
			   ...
			   If PrintType>=2 Then FieldStr=FieldStr & ",I.PhotoUrl,I.DownContent As Intro,I.DownSize,I.Rank,I.Origin,I.Author"
			   If PrintType>=3 Then FieldStr=FieldStr & ",I.ReadPoint"
			  Case 4  
			   FieldStr  = "I.ID,I.Title,I.Tid,I.OTid,I.AvgScore,I.Inputer,I.Fname,I.AddDate,I.Popular,I.Hits,I.CmtNum"
	  ...
	  End Function
		...
		Function GetSlide(LabelStyle)
			 ...
			 If ModelID="0" Then 
			  TableName = "[KS_ItemInfo]" : FieldStr="I.InfoID as ID,I.Title,I.ChannelID,I.Tid,I.PhotoUrl,I.Fname,I.Intro"
			  Param = Param & " and PhotoUrl<>''"
			 ElseIf ModelID="-1000" Then
			  ClassID=ParamNode.getAttribute("classid")
			  TableName = "[KS_GuestBook]" : FieldStr="id,Subject as title,-1000 as channelid,0 as  tid,face as photourl,id as fname,subject as intro" : Param=" Where verific=1 and isslide=1 and deltf=0"
			  if classid<>0 then
			    if instr(classid,",")=0 then
			 ...
			 ElseIf ModelID="-1001" Then
			  TableName = "[KS_BlogInfo]" : FieldStr="id,Title,-1001 as channelid,0 as tid,photourl,userid,title as intro" : Param=" Where status=0 and photourl<>'' and isslide=1"
			  ClassID=ParamNode.getAttribute("classid")
			  if classid<>0 then
			    if instr(classid,",")=0 then
			 ...
			 ElseIf ModelID="-1002" Then
			  TableName="[KS_Special]" :FieldStr="SpecialID as id,SpecialName AS Title,-1002 as channelid,0 as tid,photourl,SpecialNote as intro,SpecialEname,FsoSpecialIndex" : Param=" Where slide=1 and photourl<>''"
			  ClassID=ParamNode.getAttribute("classid")
			  if classid<>0 then
			    if instr(classid,",")=0 then
			 ...
			 ElseIf ModelID="-1003" Then
			  TableName="[KS_Advertise]" :FieldStr="id,sitename AS Title,-1003 as channelid,0 as tid,gif_url as photourl,intro,url" : Param=" Where 1=1"
			  ClassID=ParamNode.getAttribute("classid")
			  if classid<>0 then
			    if instr(classid,",")=0 then
		...
		Function GetNavigation(LabelStyle)
			 ...
			 select case channelid
			   ...
			   case "9998"
					  ...
					  End If
					  SqlStr=SqlStr & " And TopFlag=1 and DelTF=0  Order BY root,FolderOrder"
