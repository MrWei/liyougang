...
Class KesionStaticCls
		...
		Sub GetRecords()
		  If DataBaseType=1 Then
			    Dim Cmd : Set Cmd = Server.CreateObject("ADODB.Command")
				Set Cmd.ActiveConnection=conn
				Cmd.CommandText="KS_ShowsContent"
				Cmd.CommandType=4	
				CMD.Prepared = true 	
				 ...
				 Case 3
					   ...
					   For r=1 to pagenum
							  if n<=ubound(PicUrlsArr) Then
							    ...
							    ThumbList=ThumbList & "<img title=""" &Split(PicUrlsArr(n), "|")(0) & """ class=""scrollLoading"" onclick=""javascript:window.open(this.src)"" alt='" & Split(PicUrlsArr(n), "|")(0) & "' style=""cursor:hand;background:url(" & KS.GetDomain &"images/default/loading.gif) no-repeat center;""  data-url=""" & BigPic &""" src=""" & KS.GetDomain &"images/default/pixel.gif"" border='0'><br/><span>" & Split(PicUrlsArr(n), "|")(0) & "</span>"
							  Else 
							    Exit For
							  End If
							  n=n+1
