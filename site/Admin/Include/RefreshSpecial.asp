...
Class RefreshSpecial
		...
		Public Sub Kesion()
			...
			.Write "      <td width=""78%"" height=""50""> <input class=""textbox"" name=""TotalNum"" onBlur=""CheckNumber(this,'专题数量');"" type=""text"" id=""TotalNum"" style=""width:20%"" value=""20"">"
			.Write "        个专题"
			...
			.Write "          <tr>"
			.Write "            <td width=""39%""> <select name=""FolderID"" size=10 multiple style=""width:360px"">"
			...
			.Write "          <tr>"
			.Write "            <td width=""39%"">"
			.Write "            <select name=""FolderID"" size=12 multiple  style=""width:360px"">"
