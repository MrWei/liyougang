...
Class RefreshCommonPage
		...
		If Not KS.ReturnPowerResult(0, "KMTL20003") Then                '发布自定义页面的权限检查
			  Call KS.ReturnErr(1, "")
		End If
		...
		Response.Write "  <tr>"
		Response.Write "    <td height=""35"" colspan=""2"" class=""sort"">　<strong><font color=""#000099"">发布自定义页面操作</font></strong></td>"
		Response.Write "  </tr>"
		...
		Response.Write "              <select name=""TempPageID"" size=12 multiple id=""TempPageID"" style=""width:300px"">"
