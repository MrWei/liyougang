...
Class Label_Main
	  ...
	  function AddNewPageStyle(){
		...
		<div class="topdashed sort" style="text-align:left">分页样式管理 <a href="javascript:AddNewPageStyle()">添加新样式</a></div>
...
function GetKeyDown(){
		...
		Response.Write "<body  onkeydown=""GetKeyDown();"" onselectstart=""return false;"" topmargin=""0"" leftmargin=""0"">"
		   ...
		   End If
			 ...
			 Else
				If LabelType = 0 Then
				   Response.Write ("<img src='../Images/home.gif' align='absmiddle'><span style='cursor:pointer' onclick=""SendFrameInfo('Label_Main.asp?LabelType=0','../Template_Left.asp','../Post.Asp?ButtonSymbol=FunctionLabel&OpStr=标签管理 >> <font color=red>系统函数标签</font>')"">系统标签首页</span>")
				ElseIf LabelType=5 Then
				  Response.Write ("<img src='../Images/home.gif' align='absmiddle'><span style='cursor:pointer' onclick=""SendFrameInfo('Label_Main.asp?LabelType=5','../Template_Left.asp','../Post.Asp?ButtonSymbol=FunctionLabel&OpStr=标签管理 >> <font color=red>自定义函数标签</font>')"">自定义函数标签首页</span>")
				Else
				   Response.Write ("<img src='../Images/home.gif' align='absmiddle'><span style='cursor:pointer' onclick=""SendFrameInfo('Label_Main.asp?LabelType=1','../Template_Left.asp','../Post.Asp?ButtonSymbol=FunctionLabel&OpStr=标签管理 >> <font color=red>自定义静态标签</font>')"">自定义静态标签首页</span>")
				End If
			   Response.Write (">>> 搜索结果: ")
	...
	'	Response.Write "       <td align=""center"">更新时间</td>"
		...
		End Sub
		 ...
		 Do While Not LabelRS.EOF
		   ...
		   Response.Write " <td class='splittd' style='text-align:left'>"
		             If LabelRS(4) = 0 Then
					   Response.Write ("<img src=""../Images/Folder/Smallfolder.gif"" align=""absmiddle""> ")
					 ElseIf LabelType = 1 Then
		...
		Sub LabelFolderDel()
		  ...
		  Next
		   Set RS=Nothing
		   KS.AlertHintScript "恭喜，选中的标签目录删除成功!"
		End Sub
		'删除标签
		Sub LabelDel()
			Dim K, ID,Page
