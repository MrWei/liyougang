...
Class RefreshHtml
	...
	Sub refreshlist()
		...
		.Write "      <td width=""78%"" height=""35""> <input class=""textbox"" name=""TotalNum"" onBlur=""CheckNumber(this,'" & ChannelStr & "');"" type=""text"" id=""TotalNum"" style=""width:20%"" value=""50"">"
	  ...
	  .Write "  </form>"
		...
		.Write "      <td height=""35""> 从"
		.Write "        <input name=""StartDate"" class=""textbox"" onclick=""WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"" type=""text"" id=""StartDate"" readonly style=""width:20%"" value=""" & Date & """>"
		.Write "        <b><a href=""javascript:;"" onclick=""WdatePicker({el:document.DateForm.StartDate,dateFmt:'yyyy-MM-dd HH:mm:ss'});return false;""><img src=""../Images/date.gif"" border=""0"" align=""absmiddle"" title=""选择日期""></a></b>"
		.Write "        到"
		.Write "        <input name=""EndDate"" class=""textbox"" onclick=""WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"" type=""text"" id=""EndDate"" readonly style=""width:20%"" value=""" & Date & """>"
		.Write "        <b><a href=""javascript:;"" onclick=""WdatePicker({el:document.DateForm.EndDate,dateFmt:'yyyy-MM-dd HH:mm:ss'});return false;""><img src=""../Images/date.gif"" border=""0"" align=""absmiddle"" title=""选择日期""></a></b>的" & ChannelStr
