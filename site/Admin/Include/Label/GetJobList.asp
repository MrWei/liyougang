...
Class GetJobList
		...
		Dim ClassID, OpenType, RecommendTF, ShowPin,ShowNewFlag,Num, ZWLen, TitleLen, InfoSort, ColNumber, Province, NavType, Navi, DateRule, DateAlign, TitleCss, City,ShowStyle, PrintType,AjaxOut,LabelStyle,Page
       ...
       function InsertLabel(label)
		...
		.echo "            <tr class=tdbg>"
		.echo "              <td colspan='2' id='ShowFieldArea' class='field'><li onclick=""InsertLabel('{@autoid}')"">行 号</li><li onclick=""InsertLabel('{@jobcompanyurl}')"">公司URL</li> <li onclick=""InsertLabel('{@companyname}')"">公司名称</li><li onclick=""InsertLabel('{@companyshortname}')"">公司短名称</li><li onclick=""InsertLabel('{@logo}')"">公司Logo</li> <li onclick=""InsertLabel('{@jobzwlist}')""><font color=red>职位列表</font></li><li onclick=""InsertLabel('{@province}')"">公司省份</li><li onclick=""InsertLabel('{@city}')"">城市</li><li onclick=""InsertLabel('{@contactman}')"">联系人</li><li onclick=""InsertLabel('{@tel}')"">联系电话</li> <li onclick=""InsertLabel('{@email}')"">公司Email</li><li onclick=""InsertLabel('{@fax}')"">公司传真</li><li onclick=""InsertLabel('{@joindate}')"">加入时间</li><li onclick=""InsertLabel('{@newimg}')"" title='显示新信息图片标志' style='color:red;'>最新图标志</li></td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
