...
Class GetJobResumeList
		...
		Dim JobType, OpenType, RecommendTF, AcceptRecommend,Num,  InfoSort, ColNumber, Province, NavType, Navi, DateRule, DateAlign, TitleCss, City,ShowStyle, PrintType,AjaxOUT,LabelStyle,Page
		...
		function CheckForm()
		{
			...
			var NavType=1;
			var Province,City,RecommendTF,AcceptRecommend;
		...
		.echo "            <tr class=tdbg>"
		.echo "              <td colspan='2' id='ShowFieldArea' class='field'><li onclick=""InsertLabel('{@autoid}')"">行 号</li><li onclick=""InsertLabel('{@jobresumeurl}')"">简历URL</li> <li onclick=""InsertLabel('{@realname}')"">姓名</li><li onclick=""InsertLabel('{@sex}')"">性别</li><li onclick=""InsertLabel('{@resumeage}')"">年龄</li><li onclick=""InsertLabel('{@school}')"">毕业学校</li><li onclick=""InsertLabel('{@qualifications}')"">学历</li><li onclick=""InsertLabel('{@professional}')"">专业</li><li onclick=""InsertLabel('{@workexperience}')"">工作年限</li><li onclick=""InsertLabel('{@photo}')"">照片地址</li> <li onclick=""InsertLabel('{@jobtype}')"">工作类型</li><li onclick=""InsertLabel('{@func1}')"">期待职位1</li><li onclick=""InsertLabel('{@func2}')"">期待职位2</li><li onclick=""InsertLabel('{@salary}')"">期望待遇</li><li onclick=""InsertLabel('{@adddate}')"">发布时间</li><li onclick=""InsertLabel('{@province}')"">省份</li><li onclick=""InsertLabel('{@city}')"">城市</li><li onclick=""InsertLabel('{@hits}')"">浏览次数</li><li onclick=""InsertLabel('{@username}')"">用户名</li></td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
