...
Class GetJobZWList
		...
		Dim JobType, OpenType, RecommendTF,ShowJiPinFlag, Num,  InfoSort, ColNumber, Province, NavType, Navi, DateRule, DateAlign, JiPin, City,ShowStyle, PrintType,AjaxOut,LabelStyle,Page
		...
		.echo "            <tr class=tdbg>"
		.echo "              <td colspan='2' id='ShowFieldArea' class='field'><li onclick=""InsertLabel('{@autoid}')"">行 号</li><li onclick=""InsertLabel('{@jobzwurl}')"">职位URL</li> <li onclick=""InsertLabel('{@jobtitle}')"">职位名称</li><li onclick=""InsertLabel('{@companyshortname}')"">单位简称</li><li onclick=""InsertLabel('{@companyname}')"">单位全称</li><li onclick=""InsertLabel('{@jobcompanyurl}')"">单位URL</li><li onclick=""InsertLabel('{@province}')"">工作省份</li><li onclick=""InsertLabel('{@city}')"">城市</li><li onclick=""InsertLabel('{@sex}')"">性别</li><li onclick=""InsertLabel('{@qualifications}')"">学历</li><li onclick=""InsertLabel('{@workexperience}')"">工作经验</li> <li onclick=""InsertLabel('{@zpnum}')"">人数</li><li onclick=""InsertLabel('{@salary}')"">待遇</li><li onclick=""InsertLabel('{@refreshtime}')"">时间</li><li onclick=""InsertLabel('{@hits}')"">浏览数</li><li onclick=""InsertLabel('{@jipin}')"" style='color:red'>急聘</li></td>"
		.echo "            </tr>"
		.echo "            <tr class=tdbg>"
		...
		.echo "                <select name=""NavType"" style=""width:70%;"" class='textbox' onchange=""SetNavStatus()"">"
		 ...
		 .echo "           </tr>"
		 		...
		 		.echo "            <tr id=""ClassArea"" class=tdbg>"
		.echo "              <td width=""50%"" height=""24"" colspan=""2""><strong>显示条件：</strong><br>"
		If JobType="0" Then
