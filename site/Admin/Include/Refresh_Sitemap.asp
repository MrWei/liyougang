...
If KS.G("Action")<>"" Then
	...
	elseif  KS.G("Action")="createbaidu" then
		...
		SqlStr="Select top " & prioritynum & " InfoID,Title,Tid,0,0,Fname,ChannelID From KS_ItemInfo Where deltf=0 And verific=1 Order By ID desc"
		rs.Open SqlStr,conn,1,1
		for i=1 to rs.RecordCount
			xmlstr=xmlstr&KS.GetItemUrl(RS("ChannelID"),RS(2),RS(0),RS(5))&vbcrlf
			Num=Num+1
...
<td height="25" class="Sort">
 <div align="center"><strong>针对搜索引擎的SiteMap 生成操作</strong></div></td>
</tr>
</table>
