...
Class FolderList
		...
		Response.Write "            <td> <a href=""javascript:OpenFolder('" & FsoItem.name & "');""><span class='FolderItem' Path='" & FsoItem.name & "' onDblClick=""OpenFolder('" & FsoItem.name & "');"" onClick='SelectFolder(this);'>"
