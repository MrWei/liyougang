...
Class FolderFileList
		...
		Response.Write "         <td><img src=""../images/Folder/folderclosed.gif"" align='absmiddle'><a href=""javascript:OpenFolder('" & FsoItem.name & "');""><span class=""FolderItem"" Path=""" & FsoItem.name & """ onDblClick=""OpenFolder('" & FsoItem.name & "');"">"
