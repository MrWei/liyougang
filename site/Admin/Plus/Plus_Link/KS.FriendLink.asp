...
Class FriendLink
		...
		<%
		 ...
		 .echo "<ul id='menu_top'>"
			  ...
			  Else
				 .echo ("<img src='Images/home.gif' align='absmiddle'><span style='cursor:pointer' onclick=""location.href='KS.FriendLink.asp';$(parent.document).find('#BottomFrame')[0].src='Post.Asp?ButtonSymbol=Disabled&OpStr=常规管理 >> <font color=red>友情链接管理首页</font>';"">链接首页</span>")
			    .echo (">>> 搜索结果: ")
		...
		End If
		 ...
		 .echo " <br/> <form action=""KS.FriendLink.asp?Action=SaveLink"" name=""LinkForm"" method=""post"">"
		 .echo "   <input name=""Flag"" type=""hidden"" id=""Flag"" value=""" & Flag & """>"
