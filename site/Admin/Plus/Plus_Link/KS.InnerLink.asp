...
Class Inner_Main
	...
	<%
		 ...
		 .echo "<ul id='menu_top'>"
		 .echo "<li class='parent' onclick=""InnerAdd();""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/a.gif' border='0' align='absmiddle'>添加站内链接</span></li>"
		 .echo "<li class='parent' onclick=""InnerControl(1);""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/as.gif' border='0' align='absmiddle'>编辑站内链接</span></li>"
		 .echo "<li class='parent' onclick=""InnerControl(2);""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/del.gif' border='0' align='absmiddle'>删除站内链接</span></li>"
		 .echo "</ul>"
		...
		Sub InnerAdd()
			   With KS
					...
					.echo "<li class='parent' onclick=""top.box.close();""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/back.gif' border='0' align='absmiddle'>关闭取消</span></li>"
					.echo "</div>"
