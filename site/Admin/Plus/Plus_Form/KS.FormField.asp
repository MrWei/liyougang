...
Class Admin_Field
		...
		.Write "<li class='parent' onclick='FieldAdd();'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/a.gif' border='0' align='absmiddle'>新增表单字段</span></li>"
		.Write "<li class='parent' onclick='FieldControl(1);'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/as.gif' border='0' align='absmiddle'>修改表单字段</span></li>"
		.Write "<li class='parent' onclick='FieldControl(2)'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/del.gif' border='0' align='absmiddle'>删除表单字段</span></li>"
