		...
		Sub SpecialMainList()
		 ...
		 Else
			...
			.echo "    <td height=""23"" align=""left"">"
					   .echo ("<img src='../../Images/home.gif' align='absmiddle'><span style='cursor:pointer' onclick=""SendFrameInfo('KS.Special.asp','Special_Left.asp','Post.Asp?ButtonSymbol=Disabled&OpStr=专题管理 >> <font color=red>管理首页</font>')"">专题首页</span>")
				   .echo (">>> 搜索结果: ")
	 ...
	 Sub showSpecialList(XML)
	  ...
	  With KS
		...
		Sub SpecialAddOrEdit()
		   Dim SpecialID,Action,SpecialName,SpecialEName,TemplateID,FsoSpecialIndex,AddDate,SpecialNote,TopTitle,PhotoUrl,ClassID,MetaKey,MetaDescript,recommend,slide
		   Dim CurrPath:CurrPath = KS.GetUpFilesDir()
			If KS.G("Action")="Edit" Then
			  ...
			  End If
			Else
			  ClassID=KS.G("ClassID"):TopTitle="添加":Action="AddSave":AddDate=Now:FsoSpecialIndex="Index.html":slide=0:recommend=0
			End If
			...
			.echo "      <td>"
			 ...
			 .echo "<script id=""SpecialNote"" name=""SpecialNote"" type=""text/plain"" style=""width:70%;height:250px;"">" &SpecialNote&"</script>"
	         .echo "<script>setTimeout(""editor = " & GetEditorTag() &".getEditor('SpecialNote',{toolbars:[" & GetEditorToolBar("Basic") &"],wordCount:false,autoHeightEnabled:false,minFrameHeight:250 });"",10);</script>"
