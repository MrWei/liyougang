...
Class DB_BackUp
	    ...
	    elseif ks.g("flag")<>"Result" then
		  .echo ("<body>")
		  .echo "<div class=""topdashed sort"">在线执行SQL语句</div>"
	...
	<tr height="25">
	 <td align="center">
	  ...
	  <tr> 
		<td valign="top"><iframe id="ExeSQLFrame" scrolling="auto" src="KS.Database.asp?Action=ExecSql&Flag=Result" style="width:100%;height:93%" frameborder=1></iframe></td>
	  </tr>
	</table>
	<% End iF%>
	</BODY>
