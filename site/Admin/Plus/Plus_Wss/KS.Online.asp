...
Class Admin_Online
		...
		.Write "<div class='topdashed sort' style='text-align:left'>"
		...
		.Write "	<a href='KS.Online.asp?action=delall' onclick=""{if(confirm('您确定要删除所有在线人数吗?')){return true;}return false;}""><font color=blue>删除所有在线人数</font></a></div>"
		End With	
