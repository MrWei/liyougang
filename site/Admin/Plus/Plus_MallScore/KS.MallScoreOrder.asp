...
Class Admin_MallScoreOrder
		...
		Public Sub Kesion()
		 With Response
			  ...
			  .Write "<li class='parent' onclick=""window.parent.frames['BottomFrame'].location.href='../../Post.Asp?OpStr='+escape('积分兑换系统 >> <font color=red>添加礼品</font>')+'&ButtonSymbol=GOSave';location.href='KS.MallScore.asp?action=Add';""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/a.gif' border='0' align='absmiddle'>添加礼品</span></li>"
