...
Class Announce_Main
		...
		Sub MainList()
		  ...
		  Sub AnnounceAddOrEdit()
				...
				.echo "                <a href=""#"" onclick=""WdatePicker({el:document.AnnounceForm.AddDate,dateFmt:'yyyy-MM-dd HH:mm:ss'});return false;""><img src=""../../Images/date.gif"" border=""0"" align=""absmiddle"" title=""选择日期""></a>"
				.echo "              </td>"
				.echo "          </tr>"
				.echo "          <tr>"
				...
				.echo "<script id=""Content"" name=""Content"" type=""text/plain"" style=""width:70%;height:300px;"">" &Content&"</script>"
	            .echo "<script>setTimeout(""editor = " & GetEditorTag() &".getEditor('Content',{toolbars:[" & GetEditorToolBar("NewsTool") &"],wordCount:false,autoHeightEnabled:false,minFrameHeight:250 });"",10);</script>"
				.echo "</td></tr>"
				.echo "</table>"
				.echo "  </form>"
				.echo "</body>"
				...
				.echo "    return false;" & vbCrLf
				.echo "   }" & vbCrLf
				.echo "  if (editor.hasContents()==false)" & vbCrLf
				.echo "  {" & vbCrLf
				.echo "    alert('请输入公告内容!');" & vbCrLf
				.echo "    editor.focus();" & vbcrlf
				.echo "    return false;" & vbCrLf
				.echo "   }" & vbCrLf
				.echo "   form.submit();"
				.echo "}"
