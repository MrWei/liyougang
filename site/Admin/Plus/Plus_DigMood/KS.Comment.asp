...
<body>
<ul id='mt'> <div id='mtl'>评论数据表管理</div></ul>
...
<%
	 ...
	 .echo "<body topmargin=""0"" leftmargin=""0"" onkeydown=""GetKeyDown();"" onselectstart=""return false;"">"
	  ...
	  .echo "<li onclick='Verific(0,0);' class='parent'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/unverify.gif' border='0' align='absmiddle'>取消审核</span></li>"
	  .echo "<li onclick='DelComment()' class='parent'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/del.gif' border='0' align='absmiddle'>删除评论</span></li>"
	  .echo "<li onclick='CommentDataBase()' class='parent' onclick='Delete()'><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/save.gif' border='0' align='absmiddle'>评论数据表</span></li>"
