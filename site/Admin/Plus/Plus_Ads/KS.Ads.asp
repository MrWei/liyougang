		...
		End If
         ...
         With Response
		   .Write "<!DOCTYPE html><html>"
			...
			.Write "function AddPlace(id){ top.openWin('添加/编辑广告位','Plus/Plus_Ads/KS.Ads.asp?Action=AddPlace&id='+id,true,580,250); }"
			.Write "</script>"
			...
			if KS.S("ACTION")<>"AddPlace" And KS.S("Action")<>"AdwSave" Then 
				...
				.Write "<li class='parent' onclick=""location.href='KS.Ads.asp?Action=Addads&place=" & KS.S("place") & "'""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/a.gif' border='0' align='absmiddle'>增加广告</span></li>"
				.Write "<li class='parent' onclick=""location.href='KS.Ads.asp?Action=Help'""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../../images/ico/s.gif' border='0' align='absmiddle'>查看说明</span></li><li></li>"
				.Write "<div>&nbsp;查看选项："
...
%>
              <form method="POST" action="?job=add&Action=Adw"  onSubmit="return isok(this)">
                <tr height=25 class='splittd' onMouseOver="this.className='listmouseover'" onMouseOut="this.className='splittd'"> 
                  ...
                  <td align="center" nowrap class='splittd'> 
                    <a href='javascript:AddPlace(<%=rsobj(0)%>)'>修改</a>
...
%>
  <p align="left">
  <p align="left" style="border-bottom:1px solid #ccc">
...
%>
 ...
 <table border=0 width=100% cellspacing=0 cellpadding=0>
            <tr> 
              <td align=center> <div class="topdashed sort">
                <%
