			...
			Sub showContent()
			  ...
			  With Response
					Do While Not RSObj.EOF
					  ...
					  End If
					   .Write "  <td class='splittd' align='center'><a href=""javascript:EditVote('"&Id&"');"">修改</a> | <a href=""javascript:DelVote('"&Id&"');"" >删除</a> | <a href=""../../../index.asp?do=vote&id=" & id & """ target=""_blank"">查看</a></td>"
					  .Write "</tr>"
