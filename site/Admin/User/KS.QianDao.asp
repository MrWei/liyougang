		 ...
		 case "del"
		  ...
		  Response.Write "<html>"
			...
			Response.Write"<body leftmargin=""0"" topmargin=""0"" marginwidth=""0"" marginheight=""0"">"
			  ...
			  Call KS.ReturnErr(1, "")
			End If
			Response.Write"<div class='topdashed sort' style='text-align:left'>签到明细: <a href='KS.qiandao.asp'>所有签到明细</a> |"
			%>
...
<table width="100%" border="0" align="center" cellspacing="0" cellpadding="0">
  <tr class="sort">
    ...
    <td width="5%"  align="center"><strong>签到心情</strong></td>
  ...
  FieldStr="id,content,qdxq,adddate,username,userip,status"
	...
	If RS.Eof And RS.Bof Then
	 Response.Write "<tr><td colspan=9 align=center height=25 class='tdbg'>还没有会员签到记录！</td></tr>"
	Else
...
For i=0 To Ubound(SQL,2)
  ...
  <tr height="25" class='list' onMouseOver="this.className='listmouseover'" onMouseOut="this.className='list'">
    ...
    <td class="splittd" align="center"> <img src="../../images/emot/<%=SQL(2,i)%>.gif"  style="border:1px solid  #ccc;width:24px;height:24px;"></td>
