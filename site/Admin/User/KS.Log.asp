...
Class Log_Main
		...
		<%
		 ...
		 .echo "<ul id='menu_top'>"
		 .echo "<li class='parent' onclick=""DelLog();""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../images/ico/del.gif' border='0' align='absmiddle'>删除选中登录记录</span></li>"
