...
Class Admin_UserProgress
		...
		Sub MainList()
		      ...
		      Dim SQL:SQL=RSC.GetRows(-1)
			  		str="<br><table width='880' align='center' cellpadding='0' cellspacing='0'"
			    ...
			    str=str & "</td><td colspan='7' class='splittd' style='border-left:1px solid #cccccc'>"
...
搜索指定用户的稿件情况:<input type='text' class="textbox" name='username'>&nbsp;<input type='submit' class='button' value='搜索用户'>
		...
		<%end if
		 str="<br><table width='880' align='center' border='0' cellpadding='0' cellspacing='0'"
		 if flag="excel" then str=str & " border='1'" Else str=str & " border='0'"
		 str=str & ">   <tr class='sort'>"
		 str=str & "  <td width='50' align='center'>序号</td>"
...
<br/><br/>
		...
		Sub showContent()
		  ...
		  Do While Not RS.EOF
		   ...
		   str=str & "</div></td><td colspan='7' height='22' class='splittd' style='border-left:1px solid #cccccc'>"
