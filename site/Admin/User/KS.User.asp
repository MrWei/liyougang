...
Class Admin_User
       ...
       Sub Kesion()
			...
			Response.Write "<span style='padding-right:20px;line-height:30px;float:right'>共有<font color=red>" & Conn.Execute("select count(1) From KS_User")(0) & "</font>位会员</span>"
		...
		Sub Main()
           ...
           <%
		    Dim GroupID:GroupID=KS.ChkClng(KS.G("GroupID"))
				...
				strGuide="<table width='100%' align='center' border='0' cellpadding='0' cellspacing='1'><tr class='list'><td align='center' height='25'>&nbsp;"
			   ...
			   End If
				...
				if rs.eof and rs.bof then
					TotalPut=0
					Response.Write strGuide & "共找到 <font color=#ff6600>0</font> 个用户&nbsp;&nbsp;&nbsp;&nbsp;</td></tr><tr class='list'><td colspan=10 align='center' height='50'>没有找到符合条件的用户！</td></tr></table>"
			 ...
			 %>
				...
				If KS.C("SuperTF")<>1 and SQL(2,i)=1 and  SQL(1,i)<>KS.C("AdminName") then
				  ...
				  End If
					...
					<a href='KS.User.asp?Action=UserLogin&UserID=<%=SQL(0,I)%>' title="登录该用户的会员中心" target="_blank">进入</a>
				<%end if
