...
Class Admin_UserMail
		...
		Public Sub Kesion()
			...
			Response.Write"<div class=""topdashed sort menu_top_fixed"" style=""text-align:left"">管理导航:<a href='KS.UserMail.asp?action=MailSub'>订阅邮件管理</a> |  <a href='KS.UserMail.asp'>发送邮件</a> | <a href='?action=MailOut'>导出邮件</a>"
			Response.Write	" </div>"
    ...
    <tr class=tdbg>
	  ...
	  <div id="c0">
	    <table>
		 <tr>
		  <td colspan="2">
	    发送篇数：<input type="text" class="textbox" name="sendnum" value="10" style="width:50px;text-align:center"/> 篇  从所有允许订阅的栏目中选择指定的篇数发送。<br/>
	    限定天数：<input type="text" class="textbox" name="sendday" value="3" style="width:50px;text-align:center"/> 天  不限制请输入0，否则只从指定天数内选择文章发送。
		 ...
		 <tr>
		   ...
		   <%
				 Response.Write "<script id=""mailtemplate"" name=""mailtemplate"" type=""text/plain"" style=""width:70%;height:300px;"">"
			%><strong>您好，感谢您参与【{$GetSiteName}】网站的订阅服务！</strong><br/>以下是本期根据您感兴趣的栏目为您发送的订阅内容:<br/><br>
{$MailContent}<br>
...
<a href="{$GetSiteUrl}" target="_blank">点此访问本站</a> | <a onClick="return(confirm('您确认取消该订阅服务吗？'))" href="{$GetCancelUrl}" target="_blank">取消订阅服务</a><br>
			<%
	             ...
	             Response.Write "<script>setTimeout(""var editor = " & GetEditorTag() &".getEditor('mailtemplate',{toolbars:[" & GetEditorToolBar("basic") &"],wordCount:false,elementPathEnabled :true,autoHeightEnabled:false,scaleEnabled:false,minFrameHeight:300 });"",10);</script>"
				%>
	  ...
	  <div id="c1" style="display:none">
	            ...
	            <%
				 Response.Write "<script id=""Content"" name=""Content"" type=""text/plain"" style=""width:70%;height:320px;""></script>"
	             Response.Write "<script>setTimeout(""var editor1 = " & GetEditorTag() &".getEditor('Content',{toolbars:[" & GetEditorToolBar("basic") &"],initialFrameHeight:320,wordCount:false,autoHeightEnabled:false,minFrameHeight:420 });"",10);</script>"
				%>
    ...
    <tr class=tdbg>
      ...
      <td>附件一.<Input class="textbox" size=30 type="text" id="file1" name="sendfile"> <input class="button"  type='button' name='Submit' value='选择...' onClick="OpenThenSetValue('Include/SelectPic.asp?ChannelID=1&CurrPath=<%=KS.GetUpFilesDir()%>',550,290,window,$('#file1')[0]);"><br />
	  附件二.<Input class="textbox" size=30 type="text" id="file2" name="sendfile"> <input class="button"  type='button' name='Submit' value='选择...' onClick="OpenThenSetValue('Include/SelectPic.asp?ChannelID=1&CurrPath=<%=KS.GetUpFilesDir()%>',550,290,window,$('#file2')[0]);"><br />
	  附件三.<Input class="textbox" size=30 type="text" id="file3" name="sendfile"> <input class="button"  type='button' name='Submit' value='选择...' onClick="OpenThenSetValue('Include/SelectPic.asp?ChannelID=1&CurrPath=<%=KS.GetUpFilesDir()%>',550,290,window,$('#file3')[0]);"><br />
