...
Class User_AdminMain
		...
		Response.Write "<ul id='menu_top'>"
			  ...
			  Else
				   Response.Write ("<img src='../Images/home.gif' align='absmiddle'><span style='cursor:pointer'>管理员首页</span>")
			   Response.Write (">>> 搜索结果: ")
...
{ $('#'+Module)[0].style.display=Value;
		...
		Do While Not RSObj.EOF
			  ...
			  Response.Write ("<td class='splittd' height=25" & TitleStr & ">&nbsp;<span ondblclick=""EditAdmin(" & RSObj("AdminID") & ");"" AdminID=""" & RSObj("AdminID") & """><img src=../Images/Folder/Admin" & Trim(CStr(RSObj("SuperTF"))) & ".gif border=0 align=absmiddle><span style=""cursor:default"">" & RSObj("UserName") & "</span><span></td>")
			  Response.Write ("<td  class='splittd' align=""center"">")
			  If RSObj("Type")="3" Then
			  ...
			  Response.Write ">删除</a>"
			  Response.write " | <a href='javascript:SetAdminPassWord(" & rsobj("adminid") &")'>设置密码</a>"
			  Response.Write ("</td></tr>")
			  RSObj.MoveNext
			 i=i+1
		...
		Response.Write "            <td colspan='3'>"
					...
					Else
						 ...
						 Response.Write ("<div id='pr' style='display:none'><input name=""PrUserName""  type=""text"" id=""PrUserName"" size=""30"" class=""textbox""></div>")
					End if
		...
		Response.Write "            <td height=""25"" colspan='3'>"
		Response.Write "             <table border='0' cellspacing='0' cellpadding='0'><tr><td><input name=""PassWord"" type=""password"" size=""30"" class=""textbox"" onkeyup=""javascript:if(this.value!=''){$('#ps').show();setPasswordLevel(this, document.getElementById('passwordLevel'));}"" onmouseout=""javascript:setPasswordLevel(this, document.getElementById('passwordLevel'));"" onblur=""javascript:setPasswordLevel(this, document.getElementById('passwordLevel'));""> </td><td align='left' id='ps' style='display:none'>密码强度："
                          ...
                          <tr> 
                            <td><table border="0" cellspacing="0" cellpadding="0">
                                <tr align="left" class="TempletItem"> 
                                  ...
                                  <%if tj>1 then%>
                                   <img src="../Images/Folder/Smallfolder.gif">
                                  <%else%>
                                   <img src="../Images/Folder/domain.gif">
                                  <%end if%>
