...
Class Admin_System
		...
		With Response
			...
			If KS.G("Flag") = "Edit" Then
				...
				For n=0 To Alen
				  ...
				  ElseIf Request.Form("Setting(" & n &")")<>"" or n=16 or n=27 or n=34 Then
			...
			.Write "<div class='topdashed sort menu_top_fixed'>系统参数配置</div>"
			.Write "<div class=""menu_top_fixed_height""></div>"
			.Write "<div style='height:15px;overflow:hidden'></div>"
		...
		.Write "</div>"
			...
			.Write "	</SCRIPT>"
			.Write "<dl class=""dtable"">"
			.Write "<dd><div>网站首页模板：</div><input class='textbox' name=""Setting(110)"" id=""Setting110"" type=""text"" value=""" & Setting(110) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting110')[0]") & " <a href='../../index.asp' target='_blank'>页面:/index.asp</a>"
			.Write "    </dd>"
		
			.Write "    <dd><div>全站搜索模板：</div><input class='textbox' name=""Setting(139)"" id=""Setting139"" type=""text"" value=""" & Setting(139) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting139')[0]") & " <a href='../../plus/search/' target='_blank'>页面:/plus/search/</a></dd>"			
			.Write "    <dd"
			if KS.GetAppStatus("special")=false then .write " style='display:none'"
			.Write ">"
			.Write "  <div>专题首页模板：</div><input  class='textbox' name=""Setting(111)"" id=""Setting111"" type=""text"" value=""" & Setting(111) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting111')[0]") & " <a href='../../item/specialindex.asp' target='_blank'>页面:/item/specialindex.asp</a></dd>"
		   ...
		   Else
		    .Write "<font>"
		   End If
			.Write "    <dd><div>PK首页模板：</div><input  class='textbox' name=""Setting(102)"" id=""Setting102"" type=""text"" value=""" & Setting(102) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting102')[0]") & " <a href='../../plus/pk/index.asp' target='_blank'>页面:/plus/pk/index.asp</a></dd>"
			.Write "    <dd><div>PK页模板：</div><input  class='textbox' name=""Setting(103)"" id=""Setting103"" type=""text"" value=""" & Setting(103) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting103')[0]") & " <a href='#'>页面:/plus/pk/pk.asp</a></dd>"
			.Write "    <dd><div>PK观点更多页模板：</div><input  class='textbox' name=""Setting(104)"" id=""Setting104"" type=""text"" value=""" & Setting(104) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting104')[0]") & " <a href='#'>页面:/plus/pk/more.asp</a></dd>"
            .Write "</font>"
		   ...
		   End If
			...
			.Write "    <dd><div>论坛首页模板：</div><input  class='textbox' name=""Setting(114)"" id=""Setting114"" type=""text"" value=""" & Setting(114) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting114')[0]") & " <a href='../../club/index.asp' target='_blank'>页面:/club/index.asp</a></dd>"
			.Write "    <dd><div>论坛版面列表页模板：</div><input  class='textbox' name=""Setting(172)"" id=""Setting172"" type=""text"" value=""" & Setting(172) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting172')[0]") & " <a href='../club/index.asp' target='_blank'>页面:/club/index.asp</a></dd>"
			.Write "    <dd><div>论坛帖子页模板：</div><input  class='textbox' name=""Setting(160)"" id=""Setting160"" type=""text"" value=""" & Setting(160) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting160')[0]") & " <a href='../../club/display.asp' target='_blank'>页面:/club/display.asp</a></dd>"
			.Write "    <dd><div>论坛发帖页面模板：</div><input class='textbox'  name=""Setting(115)"" id=""Setting115"" type=""text"" value=""" & Setting(115) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting115')[0]") & " <a href='../../club/post.asp' target='_blank'>页面:/club/post.asp</a></dd>"
			.Write "    <dd><div>论坛搜索模板：</div><input  class='textbox' name=""Setting(171)"" id=""Setting171"" type=""text"" value=""" & Setting(171) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting171')[0]") & " <a href='../../club/query.asp' target='_blank'>页面:/club/query.asp</a></dd>"
		    .Write "</font>"	
			
			.Write "    <dd><div>会员首页模板：</div><input  class='textbox' name=""Setting(116)"" id=""Setting116"" type=""text"" value=""" & Setting(116) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting116')[0]") & " <a href='../../user/' target='_blank'>页面:/user/index.asp</a></dd>"
			.Write "    <dd><div>会员注册表单模板：</div><input  class='textbox' name=""Setting(117)"" id=""Setting117"" type=""text"" value=""" & Setting(117) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting117')[0]") & " <a href='../../user/reg/' target='_blank'>页面:/user/reg/</a></dd>"

			.Write "    <dd><div>会员注册成功页模板：</div><input  class='textbox' name=""Setting(119)"" id=""Setting119"" type=""text"" value=""" & Setting(119) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting119')[0]") & "</dd>"
			...
			.Write "    <dd" & dis &">"
			.Write "     <div>商城购物车模板：</div><input  class='textbox' name=""Setting(121)"" id=""Setting121"" type=""text"" value=""" & Setting(121) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting121')[0]") & " <a href='../../shop/shoppingcart.asp' target='_blank'>页面:/shop/shoppingcart.asp</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "     <div>商城收银台模板：</div><input class='textbox' name=""Setting(122)"" id=""Setting122"" type=""text"" value=""" & Setting(122) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting122')[0]") & " <a href='../../shop/payment.asp' target='_blank'>页面:/shop/payment.asp</a></dd>"

			.Write "    <dd" & dis &">"
			.Write "     <div>商城订购成功模板：</div><input class='textbox' name=""Setting(124)"" id=""Setting124"" type=""text"" value=""" & Setting(124) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting124')[0]") & " <a href='../../shop/order.asp' target='_blank'>页面:/shop/order.asp</a></dd>"
			
			.Write "    <dd" & dis &">"
			.Write "      <div>游客订单查询模板：</div><input class='textbox' name=""Setting(173)"" id=""Setting173"" type=""text"" value=""" & Setting(173) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting173')[0]") & " <a href='../../shop/myorder.asp' target='_blank'>页面:/shop/myorder.asp</a></dd>"
			
			
			.Write "    <dd" & dis &">"
			.Write "      <div>商城购物指南模板：</div><input class='textbox' name=""Setting(125)"" id=""Setting125"" type=""text"" value=""" & Setting(125) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting125')[0]") & " <a href='../../shop/ShopHelp.asp' target='_blank'>页面:/shop/ShopHelp.asp</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "      <div>商城银行付款模板：</div><input class='textbox' name=""Setting(126)"" id=""Setting126"" type=""text"" value=""" & Setting(126) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting126')[0]") & " <a href='../../shop/showpay.asp' target='_blank'>页面:/shop/showpay.asp</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "     <div>商城品牌列表页模板：</div><input class='textbox' name=""Setting(135)"" id=""Setting135"" type=""text"" value=""" & Setting(135) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting135')[0]") & " <a href='../../shop/showbrand.asp' target='_blank'>页面:/shop/showbrand.asp</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "     <div>商城品牌详情页模板：</div><input class='textbox' name=""Setting(136)"" id=""Setting136"" type=""text"" value=""" & Setting(136) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting136')[0]") & " <a href='../../shop/brand.asp' target='_blank'>页面:/shop/brand.asp</a></dd>"
			
			.Write "    <dd" & dis &">"
			.Write "     <div>商城团购首页模板：</div><input class='textbox' name=""Setting(137)"" id=""Setting137"" type=""text"" value=""" & Setting(137) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting137')[0]") & " <a href='../../shop/groupbuy.asp' target='_blank'>页面:/shop/groupbuy.asp</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "      <div>商城团购内容页模板：</div><input class='textbox' name=""Setting(138)"" id=""Setting138"" type=""text"" value=""" & Setting(138) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting138')[0]") & " <a href='../../shop/groupbuyshow.asp' target='_blank'>页面:/shop/groupbuyshow.asp</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "     <div>商城团购购物车模板：</div><input class='textbox' name=""Setting(120)"" id=""Setting120"" type=""text"" value=""" & Setting(120 ) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting120')[0]") & " <a href='../../shop/groupbuycart.asp' target='_blank'>页面:/shop/groupbuycart.asp</a></dd>"
			...
			.Write "    <dd" & dis &">"
			.Write "      <div>考试系统首页模板：</div><input class='textbox' name=""Setting(131)""  id=""Setting131"" type=""text"" value=""" & Setting(131) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting131')[0]") & " <a href='../../mnkc/' target='_blank'>页面:/mnkc/</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "      <div>试卷分类页面模板：</div><input  class='textbox' name=""Setting(132)"" id=""Setting132"" type=""text"" value=""" & Setting(132) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting132')[0]") & "</dd>"
            .Write "    <dd" & dis &">"
			.Write "     <div>试卷内容页面模板：</div><input class='textbox' name=""Setting(105)"" id=""Setting105"" type=""text"" value=""" & Setting(105) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting105')[0]") & "</dd>"			
			.Write "    <dd" & dis &">"
			.Write "      <div>试卷总分类模板：</div><input class='textbox' name=""Setting(134)"" id=""Setting134"" type=""text"" value=""" & Setting(134) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting134')[0]") & " <a href='../../mnkc/all.html' target='_blank'>页面:/mnkc/all.html</a></dd>"
			.Write "    <dd" & dis &">"
			.Write "      <div>日常练习模板：</div><input class='textbox' name=""Setting(177)"" id=""Setting177"" type=""text"" value=""" & Setting(177) & """ size=""50"">&nbsp;" & KSMCls.Get_KS_T_C("$('#Setting177')[0]") & " <a href='../../mnkc/day.html' target='_blank'>页面:/mnkc/day.html</a></dd>"
			.Write "  </dl>"
			.Write "</div>"
		...
		.Write "		</SCRIPT>"
			...
			.Write "</dd>"
			.Write "<dd><div>签到设置： <font><a href='KS.Setting.asp?action=DelQianDao' style='color:red' onclick=""return(confirm('此操作不可逆，只有改变签到开始时间时才使用，您确定清空签到记录吗？'));"">清空签到记录</a></font></div><FIELDSET><LEGEND align=left>签到系统</LEGEND>启用签到功能：<input name=""Setting(201)"" type=""radio"" onclick=""$('#qd').show()"" value=""1"""
			 ...
			 .Write ">"
			 .Write "开始时间：<input class='textbox' style='text-align:center' name=""Setting(206)"" type=""text"" size=""10"" value=""" & Setting(206) & """> 格式:年-月-日<br>"
			.Write "会员每次签到得积分：<input class='textbox' style='text-align:center'  name=""Setting(202)"" type=""text"" size=""5"" value=""" & Setting(202) & """> 分<br>"
			.Write "会员连续签到：<input class='textbox' style='text-align:center' onBlur=""CheckNumber(this,'会员连续签天数');"" name=""Setting(203)"" type=""text"" size=""5"" value=""" & Setting(203) & """> 天 得积分：<input class='textbox' style='text-align:center' onBlur=""CheckNumber(this,'会员连续签天数得积分');"" name=""Setting(204)"" type=""text"" size=""5"" value=""" & Setting(204) & """> 分<br>"
			.Write "会员每次没签到扣积分：<input class='textbox' style='text-align:center'  name=""Setting(205)"" type=""text"" size=""5"" value=""" & Setting(205) & """> 分  "
			...
			.Write "            <input class='button' type='button' name='Submit' value='选择图片地址...' onClick=""OpenThenSetValue('Include/SelectPic.asp?Currpath=" & CurrPath & "',550,290,window,$('#TBLogo')[0]);""><br/>LOGO图片透明度:<INPUT class='textbox' TYPE=""text"" NAME=""TBSetting(14)"" size=10 value="""
			...
			.Write "      <input size='50' class='textbox' id=""mapcenter"" name=""Setting(176)"" type=""text"" value=""" & Setting(176) & """ size=""20""> <input type='button' value='获取中心坐标' class='button' onclick='addMap()'/><span>电子地图默认显示的中心坐标,当商家没有标注时将默认显示这里设置的中心坐标位置。</span>"
			%>
			<script>
		  function addMap(){
...
<!--电子地图结束--->
	    ...
	    .Write "<dd>IP段白名单：<br> (注：添加多个限定IP段，请用<font color='red'>回车</font>分隔。 <br>限制IP段的书写方式，中间请用英文四个小横杠连接，如<font color='red'>202.101.100.32----202.101.100.255</font> 就限定了IP 202.101.100.32 到IP 202.101.100.255这个IP段的访问。当页面为asp方式时才有效。) <textarea name='LockIPWhite' cols='60' rows='8'>" & IPWhiteStr & "</textarea></dd>"
	    .Write "<dd>IP段黑名单：<br> (注：同上。) <br><textarea name='LockIPBlack' cols='60' rows='8'>" & IPBlackStr & "</textarea></dd>"
		.write "</dd></font>"
			.Write "   </dl>"
			.Write " </div>"
			...
			.Write " 密码加密方式<select name=""smspassmd5"">"
			.Write "<option value='0'"
			...
			.Write "        <textarea name=""Setting(154)"" cols=80 rows=2>" & Setting(154) & "</textarea> <span class=""block"">多个号码请用小写逗号隔开，如13600000000,15000000000。 </span> </dd>"
			
			Dim SmsArr:SmsArr=Split(Setting(155)&"∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮∮","∮")
			
			.Write "     <dd> <div>会员注册手机验证码：<font><a href='javascript:' onclick=""$('#Sms0').val('尊敬的用户，{$sitename}网站的注册验证码：{$code}。')"">默认</a></font></div><textarea name=""Sms0"" id=""Sms0"" cols=80 rows=4>" & SmsArr(0) & "</textarea>  <span class=""block"">可用标签{$sitename},{$code}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>会员注册成功后发送的短消息：<font><a href='javascript:' onclick=""$('#Sms1').val('尊敬的用户，在{$sitename}网站注册成功，账号：{$username} 密码：{$password}，请妥善保管。')"">默认</a></font></div><textarea name=""Sms1"" id=""Sms1"" cols=80 rows=4>" & SmsArr(1) & "</textarea>  <span class=""block"">可用标签{$sitename},{$username},{$password},{$email}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>会员找回密码验证码：<font><a href='javascript:' onclick=""$('#Sms2').val('尊敬的用户，{$sitename}网站的找回密码验证码：{$code}。')"">默认</a></font></div><textarea name=""Sms2"" id=""Sms2"" cols=80 rows=4>" & SmsArr(2) & "</textarea>  <span class=""block"">可用标签{$sitename},{$username},{$code}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>手机实名认证验证码：<font><a href='javascript:' onclick=""$('#Sms3').val('尊敬的用户，您在{$sitename}网站的手机实名认证验证码：{$code}。')"">默认</a></font></div><textarea name=""Sms3"" id=""Sms3"" cols=80 rows=4>" & SmsArr(3) & "</textarea>  <span class=""block"">可用标签{$sitename},{$username},{$code}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>稿件审核通过消息：<font><a href='javascript:' onclick=""$('#Sms4').val('您好{$inputer}，您在{$sitename}网站发表的稿件[{$title}]已通过审核。')"">默认</a></font></div><textarea name=""Sms4"" id=""Sms4"" cols=80 rows=4>" & SmsArr(4) & "</textarea>  <span class=""block"">可用标签{$sitename},{$input},{$title}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>会员中心在线充值成功提醒：<font><a href='javascript:' onclick=""$('#Sms12').val('您好{$username}，您在{$sitename}网站成功充值{$money}元,支付单号{$orderid}。')"">默认</a></font></div><textarea name=""Sms12"" id=""Sms12"" cols=80 rows=4>" & SmsArr(12) & "</textarea>  <span class=""block"">可用标签{$sitename},{$username},{$money},{$orderid}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			...
			.Write "     <dd> <div>商城订单确认提示：<font><a href='javascript:' onclick=""$('#Sms9').val('{$contactman}您好!您在{$sitename}网提交的订单{$orderid} ,金额{$money}已确认,请尽快付款！')"">默认</a></font></div><textarea name=""Sms9"" id=""Sms9"" cols=80 rows=4>" & SmsArr(9) & "</textarea>  <span class=""block"">可用标签{$orderid},{$money},{$contactman},{$time}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>商城订单支付成功提示：<font><a href='javascript:' onclick=""$('#Sms5').val('{$contactman}您好!您在{$sitename}网提交的订单{$orderid} 已于{$time}支付成功,支付金额：{$money}元！')"">默认</a></font></div><textarea name=""Sms5"" id=""Sms5"" cols=80 rows=4>" & SmsArr(5) & "</textarea>  <span class=""block"">可用标签{$orderid},{$money},{$contactman},{$time}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>商城订单发货提示：<font><a href='javascript:' onclick=""$('#Sms6').val('{$contactman}您好!在{$sitename}网购买的订单{$orderid} 已于{$time}发货，请您留意查收,快递{$express},单号{$expressno}。')"">默认</a></font></div><textarea name=""Sms6"" id=""Sms6"" cols=80 rows=4>" & SmsArr(6) & "</textarea>  <span class=""block"">可用标签{$orderid},{$expressno},{$express},{$contactman},{$time}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>商城订单退款提示：<font><a href='javascript:' onclick=""$('#Sms7').val('{$contactman}您好!在{$sitename}网购买的订单{$orderid} 已于{$time}退款，退款金额{$money}。')"">默认</a></font></div><textarea name=""Sms7"" id=""Sms7"" cols=80 rows=4>" & SmsArr(7) & "</textarea>  <span class=""block"">可用标签{$orderid},{$money},{$contactman},{$time}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>商城订单发票开出提示：<font><a href='javascript:' onclick=""$('#Sms8').val('{$contactman}您好!在{$sitename}网购买的订单{$orderid} 已于{$time}开出发票，发票抬头{$company},开票金额{$money}。')"">默认</a></font></div><textarea name=""Sms8"" id=""Sms8"" cols=80 rows=4>" & SmsArr(8) & "</textarea>  <span class=""block"">可用标签{$orderid},{$money},{$company},{$contactman},{$time}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>支付货款给卖方提示：<font><a href='javascript:' onclick=""$('#Sms10').val('您好{$contactman},您在本站销售的订单{$orderid}，已支付{$realmoney}到您的账户下,其中总货款{$totalmoney},服务费为：{$servicecharges}。')"">默认</a></font></div><textarea name=""Sms10"" id=""Sms10"" cols=80 rows=4>" & SmsArr(10) & "</textarea>  <span class=""block"">可用标签{$orderid},{$realmoney},{$contactman},{$totalmoney},{$servicecharges},{$time}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			.Write "     <dd> <div>商城发放优惠券提示：<font><a href='javascript:' onclick=""$('#Sms11').val('您好{$username},在{$sitename}获得购物优惠券，券号{$couponnum},金额{$money}元，请于{$enddate}前使用。')"">默认</a></font></div><textarea name=""Sms11"" id=""Sms11"" cols=80 rows=4>" & SmsArr(11) & "</textarea>  <span class=""block"">可用标签{$username},{$couponnum},{$money},{$enddate}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			...
			.Write "  <div>招聘单位收到简历提示：<font><a href='javascript:' onclick=""$('#Sms20').val('尊敬的{$company}负责人,在{$sitename}网{$realname}向您投放了{$jobzw}的应聘简历，请及时登录处理。')"">默认</a></font></div><textarea name=""Sms20"" id=""Sms20"" cols=80 rows=4>" & SmsArr(20) & "</textarea>  <span class=""block"">可用标签{$company},{$realname},{$jobzw},{$time}。<br><font color=blue>说明：留空表示不发送</font>  </span></dd>"
			'====================求职系统_end=====================================
		...
		Response.Write "<div style=""height:30px;text-align:center"">KeSion CMS X" & GetVersion &", Copyright (c) 2006-" & year(now)&" <a href=http://www.kesion.com/ target=""_blank""><font color=#cc6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
				Response.Write ("</body>")
				Response.Write ("</html>")
		End Sub
