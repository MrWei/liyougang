    ...
    If request("flag")<>"skin" Then
	 ...
	 End If	  
		 For Each FsoItem In FileObj
		  ...
		  .Write ("<td align='center'  class='splittd'>" & FsoItem.DateLastModified & " </td>")
		  .Write ("<td align='center'  class='splittd'> <a href='KS.Template.asp?t=" & request("flag") & "&Action=Modify&FileName=" &Server.URLEncode(FsoItem.name)&"&Flag=text&CurrPath=" & Server.URLEncode(CurrPath) & "' onclick=""$(parent.document).find('#BottomFrame')[0].src='Post.Asp?OpStr=" & server.URLEncode("模板管理中心 >> 编辑模板") &"&ButtonSymbol=GoSave'"">编辑</a>")
	  ...
	  Sub AddTemplate()
		...
		Response.Write "</font></div>"
		 ...
		 Response.Write "<table width='100%' height=""350"" style=""width:100%;height:100%;background-color:#EEEEEE;padding-right: 2px;padding-left: 2px;padding-bottom: 0px;"" border='0' align='center' cellpadding='0' cellspacing='0' class='ctable'  height='100%'>"
