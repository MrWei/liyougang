...
Class Template
		...
		With Response
		   ...
		   Else
			  ...
			  .Write (rs("fsofilename") & """ target=""_blank"">预览页面</a> | <a href='KS.DIYPage.asp?Action=Modify&ID=" & rs("templateid") &"&Flag=text' onclick=""$(parent.document).find('#BottomFrame')[0].src='Post.Asp?OpStr=" & server.URLEncode("模板管理中心 >> 编辑页面") &"&ButtonSymbol=GoSave'"">编辑</a> | <a href='KS.DIYPage.asp?Action=Del&id=" & rs("templateid")&"' onclick=""return(confirm('此操作不可逆，确定删除吗？'))"">删除</a></td>")
			  .Write "</tr>"
			  RS.MoveNext
			   i=I+1
	  ...
	  Sub AddTemplate()
		...
		Response.Write " <div class=""topdashed sort"">修改模板</div>"
		 ...
		 Response.Write "     <td height=""30"" style=""text-align:left""><b>单页名称：</b><input class=""textbox"" name=""PageName"" type=""text"" id=""PageName"" size=""30"" Value=""" & PageName & """> <font color=red>*</font>如，帮助中心，网站介绍等</td></tr>"
		 
		 Response.Write "   <tr class=""clefttitle"">"
		 Response.Write "     <td height=""30"" style=""text-align:left""><b>单页模板地址：</b><input class=""textbox"" onpropertychange=""LoadTemplateIn();"" name=""TemplateFileName"" type=""text"" id=""TemplateFileName"" size=""30"" Value=""" & TemplateFileName & """>&nbsp;"
		...
		Set KSCls=Nothing
		 ...
		 Response.Write "   <tr class=""clefttitle"">"
		 Response.Write "     <td height=""30"" style=""text-align:left""><b>生成文件名称：</b>" & KS.Setting(3) 
