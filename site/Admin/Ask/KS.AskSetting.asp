		...
		With Response
			...
			.Write "    <dd><div>模块名称：</div>"
			 ...
			 .Write "   <dd><div>是否只能回答一次：</div>"
				...
				.Write "    <span>--游客提问题的问题只能由管理员设置最佳答案，并且使用系统函数标签查询调用问题时性能有所影响，常规情况下建议不要开启游客提问</span>"
				.Write "</dd>"
			...
			.Write "<div style=""clear:both;text-align:center;color:#003300"">--------------------------------------------------------------------------------<br/>KeSion CMS X" & GetVersion & ", Copyright (c) 2006-" & year(now) &" <a href=""http://www.kesion.com/"" target=""_blank"">KeSion.Com</a>. All Rights Reserved . </div>"
