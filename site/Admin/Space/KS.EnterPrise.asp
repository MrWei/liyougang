   ...
   <input type="hidden" value="<%=username%>" name="username">
	 ...
	 <script type="text/javascript">
		  ...
		  top.openWin('电子地图标注','../plus/baidumap.asp?obj=parent.frames["MainFrame"].document.getElementById("MapMark")&MapMark='+escape($("#MapMark").val()),false,860,430);
           ...
           <td height='28'>
		   <%
				 Response.Write "<script id=""Intro"" name=""Intro"" type=""text/plain"" style=""width:80%;height:260px;"">" &Intro&"</script>"
	             Response.Write "<script>setTimeout(""var editor = " & GetEditorTag() &".getEditor('Intro',{toolbars:[" & GetEditorToolBar("basic") &"],wordCount:false,autoHeightEnabled:false });"",10);</script>"
			%>
		   </td>
          </tr>  
      </table>
