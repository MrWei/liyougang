...
Class Admin_SpaceLog
		...
		if ks.g("action")<>"showpush" then
			...
			.Write "<li class='parent' onclick=""location.href='KS.Spacelog.asp';""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../images/ico/a.gif' border='0' align='absmiddle'>博文管理</span></li>"
			.Write "<li class='parent' onclick=""location.href='?action=comment';""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../images/ico/move.gif' border='0' align='absmiddle'>博文评论</span></li>"
			.Write "<li class='parent' onclick=""location.href='?action=class';""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../images/ico/addjs.gif' border='0' align='absmiddle'>博文分类</span></li>"
			.Write	" </ul>"
		end if
		End With	
...
function topicpush(topicid,title){
		 top.openWin('博文推送','space/KS.SpaceLog.asp?topicid='+topicid+'&title='+title+'&Action=showpush',false,580,280);
}
...
<%
	...
	If Rs.bof And Rs.EOF Then
		Response.Write "<tr><td height=""25"" align=center bgcolor=""#ffffff"" colspan=7>没有人写博文！</td></tr>"
	Else
   ...
   Dim Rs,SQL,i
	...
	Do While Not Rs.EOF
		...
		If Rs("depth") > 1 Then
			...
			Response.Write "&nbsp;&nbsp;<font color=""#666666"">├</font> "
		End If
		If KS.ChkClng(Rs("parentid")) = 0 Then Response.Write ("<img src='../Images/Folder/domain.gif' align='absmiddle'/><b>")
