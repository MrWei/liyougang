 ...
 End If
	...
	%>
		<script language = "JavaScript">
				...
				<%
				 Response.Write "<script id=""Content"" name=""Content"" type=""text/plain"" style=""width:80%;height:320px;"">" &rs("content")&"</script>"
	             Response.Write "<script>setTimeout(""var editor = " & GetEditorTag() &".getEditor('Content',{toolbars:[" & GetEditorToolBar("basic") &"],wordCount:false,autoHeightEnabled:false,minFrameHeight:420 });"",10);</script>"
				%>
