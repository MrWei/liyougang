...
Class Admin_Ask_Class
		...
		<tr align="center">
			...
			<td class="splittd">
			 <a href="javascript:window.$(parent.document).find('#BottomFrame')[0].src='Post.Asp?OpStr=论坛系统 >> <font color=red>勋章详情设置</font>&ButtonSymbol=GoSave';location.href='?action=modify&id=<%=DataArry(0,i)%>'">详情</a> 
