...
Class MainCls
		...
		Sub MainList()
		 With Response
			...
			.Write "<body topmargin=""0"" leftmargin=""0"">"
			  ...
			  .Write "<li class='parent' onclick=""location.href='../plus/Plus_Tool/KS.Tools.asp#Club';""><span class=child onmouseover=""this.parentNode.className='parent_border'"" onMouseOut=""this.parentNode.className='parent'""><img src='../images/ico/s.gif' border='0' align='absmiddle'>重计论坛数据</span></li>"
  ...
  <tr>
    ...
    <td><input type='text' class='textbox' style='text-align:center' name='setarr(35)' size=5 value='<%=setarr(35)%>'/></td>
				...
				.Write "<script id=""BoardRules"" name=""BoardRules"" type=""text/plain"" style=""width:80%;height:360px;"">" &BoardRules & "</script>"
				.Write "<script>var editor = " & GetEditorTag() &".getEditor('BoardRules',{toolbars:[" & GetEditorToolBar("basic") &"],wordCount:false});</script>"
				.Write "            </dd>"
				.Write "</dl>"
				.Write "</div>"
		  ...
		  Sub GuestBoardSave()
		   ...
		   End If
			  ...
			  End If
			   ...
			   Response.Write ("<script> top.$.dialog.confirm('版块添加成功!继续添加吗?',function(){location.href='club/KS.GuestBoard.asp?Action=Add&parentid=" & ParentID &"';},function(){location.href='club/KS.GuestBoard.asp';$(parent.document).find('#BottomFrame')[0].src='Post.Asp?ButtonSymbol=Disabled&OpStr=论坛系统 >> <font color=red>论坛版块管理</font>';});</script>")
		   ...
		   End If
			  ...
			  Response.Write ("<script>top.$.dialog.alert('版块修改成功!',function(){location.href='club/KS.GuestBoard.asp?Page=" & Page & "';$(parent.document).find('#BottomFrame')[0].src='Post.Asp?ButtonSymbol=Disabled&OpStr=论坛系统 >> <font color=red>论坛版块管理</font>';});</script>")
			End If
		  End Sub
