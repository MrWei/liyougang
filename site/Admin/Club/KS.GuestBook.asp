...
Sub Nav()
%>
<div class='topdashed sort menu_top_fixed' style="text-align:left;padding-left:10px">
<a href="KS.GuestBook.asp">主题管理</a>  <a href="KS.GuestBook.asp?Action=Recycle">帖子回收站</a>  <a href="?Action=Comment">帖子点评管理</a> <a href="?Action=VerifyReply">帖子回复审核</a> <a href="?action=Delete">按条件删除操作</a>
</div>
<div class="menu_top_fixed_height"></div><br> 
<%
End Sub
...
<table border="0" width="100%" align="center" cellpadding="0" cellspacing="0">
		...
		<tr class="list">
		  <td height="40" align="right" width="200"><strong>版面限制：</strong></td><td>
		      <%With Response
			    .Write " <select name='boardid' id='boardid'>"
...
<%
 ...
 Sub VerifyReply()
   ...
   %>
   <label><input type="checkbox"  name='selectCheck' onClick="if(this.checked){Select(0)}else{Select(1)}">全部选中</label>
