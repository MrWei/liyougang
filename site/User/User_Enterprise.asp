...
Class User_EditInfo
 ...
 %>
	...
	<%	   
	 Dim CompanyName,Province,City,Address,ZipCode,ContactMan,Telphone,Fax,WebUrl,Profession,CompanyScale,RegisteredCapital,LegalPeople,BankAccount,AccountNumber,BusinessLicense,Intro,flag,ClassID,SmallClassID,qq,mobile,Email,MapMarker,Business,Foundation,isrz
					 ...
					 <td align="left">
					  <table border="0" cellspacing="0" cellpadding="0">
						...
						<td width="410" height="40"><iframe id='UpPhotoFrame' name='UpPhotoFrame' src='User_UpFile.asp?Type=Pic&ChannelID=9990&MaxFileSize=150&ext=*.jpg;*.gif;*.png' frameborder="0" scrolling="No" align="center" width='400' height='40'></iframe>
						  ...
						  <tr class="tdbg">
                            <td align="center" colspan="2"><button class="pn" name="Submit" type="submit"><strong>OK,确 认 保 存</strong></button></td>
                          </tr>
	</table>
				</form>
  <%
