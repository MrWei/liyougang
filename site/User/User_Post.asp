		...
		<script language = "JavaScript">
		   ...
		   function GetKeyTags(){
			...
			function CheckForm(){
				...
				<%If FieldXML.DocumentElement.selectsinglenode("fielditem[@fieldname='content']/showonuserform").text="1" Then%>
				     if (($("#Changes:checked").val()!="1")&&(editor.hasContents()==false))
					{
...
<%
 ...
 Sub DoSaveArticle()
   	Dim Title,FullTitle,KeyWords,Author,Origin,Intro,Content,Verific,PhotoUrl,I,Province,City,FileIds,ReadPoint,ChangesUrl,Changes
