				  ...
				  <td class="splittd">
				      <table>
						...
						<tr>
						 ...
						 <td>
						  <div id="copytext" style="border:1px solid #cccccc;height:45px;width:650px;overflow:scroll"><%=Replace(Replace(Server.HTMLEncode(KS.Setting(142)),"{$UID}",KSUser.UserName),"{$GetSiteUrl}",KS.GetDomain)%></div>
				...
				<td class="splittd"><br/>
				  <table>
				   ...
				   <tr>
					...
					<td>
					 <div style="border:1px solid #cccccc;height:45px;width:650px;overflow:scroll" id="copytext1"><%=KS.GetDomain%>user/reg/?uid=<%=KSUser.GetUserInfo("UserId")%></div>
									<br/>
