		...
		End Sub
		 ...
		 Sub S_AddEdit()
			...
			<script type="text/javascript">
			  ...
			  <table cellSpacing=1 cellPadding=3 width="98%" align=center border=0 style="margin:10px;">
                          <tr>
                              <td colSpan=2 class="titleinput"> <span style="font-weight:bold; color:#006699">请填写收货信息</span> </td>
                          </tr> 
                          <tr class=tdbg>
                          ...
                          <tr class=tdbg>
                           ...
                           <tr class=tdbg>
                             ...
                             <td><INPUT class="textbox" maxLength=50 size=20 value="<%=Mobile%>" name="Mobile" id="Mobile">
                                                或固定电话<INPUT maxLength=50 size=20 value="<%=Phone%>" name="Phone" id="Phone">*<span class='tips'>两个至少填一个</span> </td>
                            </tr>
                            <tr class=tdbg>
