...
%>
								...
								<form action="User_EnterPriseNews.asp" method="post" name="searchform">  <strong>促销信息搜索：</strong>  关键字<input type="text" name="KeyWord" class="textbox" value="关键字" onfocus="if(this.value=='关键字'){this.value=''}" size=20>&nbsp;<input class="button" type="submit" name="submit1" value=" 搜 索 "> </form>
								  </td>
