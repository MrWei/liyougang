		...
		%>
			   ...
			   %>
							   <style type="text/css">
								...
								.t .onmouseout {}
								.t ul {float:left;margin:6px;padding:5px;width:165px;height:225px;overflow:hidden;border: 1px #f4f4f4 solid;background: #fcfcfc;}
								.t ul li {
								...
								.t ul li.l4 {margin:2px 0 0 0;text-align:center;}
							   </style>
							   <%
								 dim i,k
								 do while not rs.eof
