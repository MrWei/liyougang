  ...
  Sub groupbuyShowContent()
   ...
   Do While Not RS.Eof
		%>
         ...
         <tr class='tdbg' onMouseOver="this.className='tdbg tdbg-mouseover'" onMouseOut="this.className='tdbg'">
...
function ChangesNews(){ 
		  ...
		  <tr class="tdbg" onMouseOver="this.className='tdbgmouseover'" onMouseOut="this.className='tdbg'" id='ContentLink'>
          ...
          <tr class="tdbg" onMouseOver="this.className='tdbgmouseover'" onMouseOut="this.className='tdbg'">
            ...
            <td height='30'>&nbsp;开始<input type='text' onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" class='textbox' name='AddDate' value='<%=AddDate%>' size="20" /> 
          ...
          <div style="display:none">
		   ...
		   <tr class="tdbg" onMouseOver="this.className='tdbgmouseover'" onMouseOut="this.className='tdbg'">
            ...
            <td height='30' colspan="2">
			 <%
				 Response.Write "<script id=""Intro"" name=""Intro"" type=""text/plain"" style=""width:70%;height:200px;"">" &KS.ClearBadChr(Intro)&"</script>"
		  ...
		  <tr class="tdbg" <%if AllowBMFlag<>2 then response.write " style='display:none'"%> id="showgroup" onMouseOver="this.className='tdbgmouseover'" onMouseOut="this.className='tdbg'">
