                ...
                for p = startpage to pageNum
                    if (p = CurrPage) then
                        pageStr=pageStr & " <a href=""#"" class=""curr"">" & p & "</a>"
                         ...
                         pageStr=pageStr & " <a class=""num"" href=""javascript:turn(" & p& ");"">" & p & "</a>"
                    end if
                    nn=nn+1
...
if (instr(Tp,"{$turnpage}")<>0) then
                pageStr="<select name=""page"" id=""turnpage"" onchange=""javascript:turn(this.options[this.selectedIndex].value);"">"
                for j = 1 to pageNum
