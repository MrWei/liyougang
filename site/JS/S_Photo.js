...
document.writeln('<option value=\'694\'>图片频道 </option><option value=\'694:1165\'>──概念家居 </option><option value=\'694:1163\'>──美女图片 </option><option value=\'694:1162\'>──旅游风景 </option><option value=\'694:1203\'>──自然风景 </option><option value=\'694:1204\'>──萌宠大全 </option><option value=\'694:1205\'>──混搭风格 </option><option value=\'694:1206\'>──影视壁纸 </option><option value=\'694:1529\'>──美食每刻1 </option><option value=\'735:1208\'>──动漫图库 </option>        </select>')
...
function turnsearch(){location.href='http://192.168.0.10/item/index.asp?c-'+$('#m_id').val()+',tid-'+$('#m_tid').val()+',t-'+$('#m_t').val()+',key-'+$('#m_key').val()+'.html';}
